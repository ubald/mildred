...
namespace UWalker
{
    ...
    class Gait
    {
        public:
            ...
            virtual KDL::Vector walk( UWalker::GaitConfig &legGait );

        protected:
            Gait( UWalker::EGaitSequence sequence );
            virtual ~Gait();
            virtual KDL::Vector calculate( UWalker::GaitConfig &legGait ) = 0;

            static const double cycleDuration = 1.00; // Duration of a cycle, PI could be used also
